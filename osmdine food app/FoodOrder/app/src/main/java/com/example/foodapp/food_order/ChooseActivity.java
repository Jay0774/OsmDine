package com.example.foodapp.food_order;
...
import com.example.foodapp.food_order.Common.Common;
import com.example.foodapp.food_order.Model.User;
import com.example.foodapp.food_order.Server.HomeActivityServer;
import com.example.foodapp.food_order.Server.MainActivityServer;
...
import static com.example.foodapp.food_order.Common.Common.CLIENT;
import static com.example.foodapp.food_order.Common.Common.SERVER;
import static com.example.foodapp.food_order.Common.Common.USER_NAME;
import static com.example.foodapp.food_order.Common.Common.USER_PASSWORD;
import static com.example.foodapp.food_order.Common.Common.USER_PHONE;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            @SuppressLint("PackageManagerGetSignatures") PackageInfo info =
                    getPackageManager().getPackageInfo("com.example.foodapp.food_order",
